...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    private static final int TAB_VIEW_PADDING_SIDE_DIPS = 16;
    ...
    private void populateTabStrip() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            if (desc != null) tabView.setContentDescription(desc);

            mTabStrip.addView(tabView);
            if (i == mViewPager.getCurrentItem()) tabView.setSelected(true);

            if (tabTitleView != null) tabTitleView.setTextColor(getResources().getColorStateList(R.color.selector));
            CalligraphyUtils.applyFontToTextView(getContext(), tabTitleView, "fonts/IranianSansLight.ttf");
            if (tabTitleView != null) tabTitleView.setTextSize(14);
        }
        ...
        if (!mDistributeEvenly) {
            ...
            mTabStrip.setPadding(
                    0,
                    0,
                    getResources().getDimensionPixelSize(R.dimen.abc_action_bar_content_inset_material),
                    0);
        }
